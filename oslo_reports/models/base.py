...
class ReportModel(MutableMapping[str | int, Any]):
    """A Report Data Model
    ...
    attached_view: Any
    # Keys may be str (normal attribute access) or int (sequence-derived data)
    data: dict[Any, Any]

    def __init__(
        self,
        data: Mapping[Any, Any] | Sequence[Any] | None = None,
        attached_view: Any = None,
    ) -> None:
    ...
    def __str__(self) -> str:
        ...
        if self.attached_view is not None:
            return cast(str, self.attached_view(self_cpy))
        else:
    ...
    def __getitem__(self, attrname: str | int) -> Any:
        return self.data[attrname]

    def __setitem__(self, attrname: str | int, attrval: Any) -> None:
        self.data[attrname] = attrval

    def __delitem__(self, attrname: str | int) -> None:
